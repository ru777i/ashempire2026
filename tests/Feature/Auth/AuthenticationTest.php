...
test('users are redirected to their role-based dashboard after login', function (string $role, string $routeName) {
    ...
    ['formateur', 'dashboardFormateur'],
    ['apprenant', 'dashboardAprenant'],
]);
